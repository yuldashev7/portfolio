...
const SingleProject = ({ project }) => {
  ...
  return (
    <div className="group w-full h-fit flex flex-col items-center justify-center relative cursor-text overflow-hidden px-3 md:px-8 py-[1.4rem] bg-[linear-gradient(90deg,#281e57_0%,#201435_100%)] shadow-2xl rounded-lg border border-[#1a1443]">
      ...
      <div className="flex flex-col items-center justify-between w-full h-full">
        ...
        <div className="p-6">
          <Image
            ...
            width={1080}
            height={720}
            className="w-80 h-64 transition-opacity duration-700 delay-[0.3s] rounded-lg group-hover:opacity-0"
          />
        </div>
        <div className="flex items-center justify-between w-full">
          <Link
            href={demo}
            target="_blank"
            className="flex justify-center items-center w-10 h-10 rounded-full border-2 border-[#EFF3F4] text-[#EFF3F4] transition-all duration-300 hover:bg-[#231d4b] hover:text-violet-600 hover:border-[#0F0C41] hover:scale-110 box-decoration-clone cursor-pointer no-underline delay-[0.3s]"
          >
            <FaPlay />
          </Link>
          ...
          <Link
            href={code}
            target="_blank"
            className="flex justify-center items-center w-10 h-10 rounded-full border-2 border-[#EFF3F4] text-[#EFF3F4] transition-all duration-300 hover:bg-[#231d4b] hover:text-violet-600 hover:border-[#0F0C41] hover:scale-110 cursor-pointer no-underline  delay-[0.3s] group-hover:-translate-x-35"
          >
            <FaCode />
          </Link>
        </div>
      ...
      <div className="group-hover:translate-x-0 absolute w-35 text-[0.8rem] flex justify-center gap-2 flex-col translate-x-full transition-transform duration-500 delay-[0.3s] p-[0.825rem] rounded-[10px_0_0_10px] right-0 bottom-4 bg-[#0f0b24] text-[#EFF3F4]">
        {tags.map((tag, id) => (
